...
namespace MortgageCalculator.Api.Repos
{
    ...
    public class MortgageRepo : IMortgageRepo
    {
            ...
            using (var context = new MortgageData.MortgageDataContext())
            {
                ...
                foreach (var mortgage in mortgages)
                {
                    result.Add(new Mortgage()
                    {
                        ...
                        TermsInMonths = MonthDiffer(mortgage.EffectiveStartDate, mortgage.EffectiveEndDate),
        ...
        Func<DateTime, DateTime, int> MonthDiffer = (startDt, endDt) => { return (endDt.Year - startDt.Year) * 12 + endDt.Month - startDt.Month; };
    }
}